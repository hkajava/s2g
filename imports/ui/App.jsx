      ...
      return (
        <div>
          <p> This is an application to help teachers divive students into small
            groups randomly. Built with Meteor.js. Free to use and open source. <a target="_blank" rel="noopener noreferrer" href="https://github.com/hkajava/s2g/"><img border="0" alt="GitHub Link" src="/images/Octocat.png" width="40" height="40" /></a>
          </p>
          <div className="selectStudentGroupCSSGridWrapper">
